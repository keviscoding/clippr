...
function CtaFooter({ onJoin }){
  return (
    <>
      <section className="m-section" style={{padding:"120px 32px",borderTop:"1px solid rgba(255,255,255,0.06)",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"relative",maxWidth:900,margin:"0 auto",textAlign:"center"}}>
          ...
          <h2 className="m-cta-h2" style={{fontSize:"clamp(48px, 7vw, 80px)",fontWeight:600,letterSpacing:"-0.035em",lineHeight:0.95,color:"#FAFAF7",margin:"0 0 24px"}}>
          ...
          <Button variant="primary" size="xl" pill onClick={onJoin} icon={<Icon name="arrow" size={16}/>}>Apply to clip for Clippr</Button>
        </div>
      </section>

      <footer className="m-section" style={{padding:"40px 32px",borderTop:"1px solid rgba(255,255,255,0.06)"}}>
